...
await page.screenshot({ path: '/tmp/bussim-shots/93-stalk.png' });
...
await page.screenshot({ path: '/tmp/bussim-shots/94-sideblinker.png' });
await browser.close();
